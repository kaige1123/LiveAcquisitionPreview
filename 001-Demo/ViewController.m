...
@interface ViewController ()<CCSystemCaptureDelegate,CCVideoEncoderDelegate, CCVideoDecoderDelegate, CCAudioEncoderDelegate, CCAudioDecoderDelegate>
...
- (void)testVideo {
    ...
    [CCSystemCapture checkMicrophoneAuthor];
    
    //捕获媒体
    _capture = [[CCSystemCapture alloc] initWithType:CCSystemCaptureTypeAll];//捕获视频和音频
